...
# time <- seq(1,45,1)  # Observation time points for the rich design
time <- seq(1,45,length.out=10) # for the sparse design
...
N  <- 800 ## Total number of plants
Na <- 200 ## Number of varieties
...
filename <- paste(resultsrepositoryname,'/ResSimus_sc2_Na',Na,'_N',N,'.Rdata',sep="")
